...
$u_id = $_GET['upid'];
$sql = "SELECT * FROM `admin` WHERE `admin_id`='$u_id'";
...
<div class="container mt-5">
    <div class="col-md-6 mx-auto shadow p-4 rounded">
        ...
        <form id="update_form">
            <input type="hidden" name="admin_id" value="<?php echo $fet['admin_id']; ?>">
            ...
            <div class="mb-3">
                <label>Role</label>
             <input type="text"  value="<?php echo $fet['role'] ?>" class="form-control" name="role" placeholder="role">
                    </div>
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            if(res == "1"){
                ...
                setTimeout(function(){ window.location="admin_view.php"; },1500);
            } else if(res == "2"){
