...
<div class="container mt-5">
    <div class="col-md-6 mx-auto shadow p-4 rounded">
        ...
        <form id="update_form">
            <input type="hidden" name="user_id" value="<?php echo $fet['user_id']; ?>">
            ...
            <div class="mb-3">
             ...
             <input type="text"  value="<?php echo $fet['password'] ?>" class="form-control" name="password" placeholder="password">
                    </div>

            <div class="mb-3">
                <label>address</label>
             <input type="text"  value="<?php echo $fet['address'] ?>" class="form-control" name="address" placeholder="address">
                    </div>

            <div class="mb-3">
                <label>city</label>
             <input type="text"  value="<?php echo $fet['city'] ?>" class="form-control" name="city" placeholder="city">
                    </div>
		   ...
		   <div class="mb-3">
             ...
             <input type="text"  value="<?php echo $fet['updated_at'] ?>" class="form-control" name="updated_at" placeholder="updated_at">
                    </div>			
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            if(res == "1"){
                ...
                setTimeout(function(){ window.location="user_view.php"; },1500);
            } else if(res == "2"){
