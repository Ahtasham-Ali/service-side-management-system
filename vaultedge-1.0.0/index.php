    ...
    <section class="ve-hero">
        ...
        <div class="ve-hero-left">
            ...
            <div class="ve-hero-btns">
                <a href="services.php" class="ve-btn-primary">Explore Services</a>
                <a href="about.php" class="ve-btn-ghost">Learn More</a>
            </div>
            <!-- Quick Stats Row -->
        ...
        <div class="container">
            ...
            <div class="ve-services-grid">
                <div class="ve-service-card wow fadeInUp" data-wow-delay="100ms">
                    ...
                    <a href="services.php" class="ve-card-link">Learn more <i class="fa fa-long-arrow-right"></i></a>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-7 wow fadeInRight" data-wow-delay="200ms">
                    <div class="ve-whyus-content">
                        ...
                        <a href="about.php" class="ve-btn-primary mt-30">Discover Our Story</a>
                    </div>
                </div>
            </div>
        </div>
